...
export const setCleanRules = (rules) => {
  cleanRules = rules;
};
 ...
 * @return Element
 **/
export const grabArticle = (document, preserveUnlikelyCandidates) => {
  /**
      ...
      if (node.innerHTML.search(regexps.divToPElementsRe) === -1) {
        ...
        Array.prototype.slice.call(node.childNodes).forEach(function(childNode) {
          if (childNode.nodeType == 3 /*TEXT_NODE*/ ) {
            ...
            console.log("replacing text node with a span tag with the same content.");
  ...
  candidates.forEach(function(candidate) {
    ...
    console.log('Candidate: ' + candidate + " (" + candidate.className + ":" + candidate.id + ") with score " + candidate.readability.contentScore);
 ...
 * @return string
 **/
export const getInnerText = function(e, normalizeSpaces) {
  var textContent = "";
